...
$form=New-Object Windows.Forms.Form;$form.Text="Little Stream Detector (LSD) 1.1";$form.ClientSize=New-Object Drawing.Size(960,810);$form.MinimumSize=New-Object Drawing.Size(760,680);$form.StartPosition='CenterScreen';$form.AllowDrop=$true;$form.KeyPreview=$true;$form.Font=New-Object Drawing.Font('Segoe UI',9)
